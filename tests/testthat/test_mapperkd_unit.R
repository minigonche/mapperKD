...
test_that("Unit Tests for: Construct Step Grid. Dimension 1", {
  ...
  res = mapperKD(k = 1, distance = matrix(rep(1,length(filter)**2), ncol = length(filter)), filter = filter, intervals = intervals, overlap = overlap, clustering_method = cluster_all, low_ram = FALSE, data = NA)
...
test_that("Unit Tests for: Construct Step Grid. Dimesnion 2", {
  ...
  step_grid = construct_step_grid(filter_min, filter_max, intervals, overlap)
  res = mapperKD(k = 2, distance = matrix(rep(1,dim(filter)[1]**2), ncol = dim(filter)[1]), filter = filter, intervals = intervals, overlap = overlap, clustering_method = cluster_all, low_ram = FALSE, data = NA)
...
test_that("Unit Tests for: Construct Step Grid. Dimesnion n", {
  ...
  step_grid = construct_step_grid(filter_min, filter_max, intervals, overlap)
  res = mapperKD(k = 3, distance = matrix(rep(1,dim(filter)[1]**2), ncol = dim(filter)[1]), filter = filter, intervals = intervals, overlap = overlap, clustering_method = cluster_all, low_ram = FALSE, data = NA)
  ...
  for(k in 1:num_ite)
  {
    ...
    step_grid = construct_step_grid(filter_min, filter_max, intervals, overlap)
    res = mapperKD(k = n, distance = matrix(rep(1,dim(filter)[1]**2), ncol = dim(filter)[1]), filter = filter, intervals = intervals, overlap = overlap, clustering_method = cluster_all, low_ram = FALSE, data = NA)
...
test_that("MapperKD Unit Tests. Error Scenarios", {
  ...
  expect_true({mapperKD(k = 2, distance = matrix(rep(1,dim(filter)[1]**2), ncol = dim(filter)[1]), filter = filter, intervals = c(intervals,intervals), overlap = c(overlap,overlap), clustering_method = cluster_all, low_ram = FALSE, data = NA); TRUE})
